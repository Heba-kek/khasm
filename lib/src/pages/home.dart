...
//        fit: StackFit.expand,
                ...
                case 'trending_week_heading':
                  return ListTile(
                    ...
                    subtitle: Text(
                      S.of(context).clickOnTheVawcharToGetMoreDetailsAboutIt,
                      maxLines: 2,
                      style: Theme.of(context).textTheme.caption,
                    ),
                  );
                ...
                case 'categories_heading':
                  return Padding(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                        S.of(context).Vawchar_categories,
                        style: Theme.of(context).textTheme.headline4,
                      ),
                    ),
                  );
          ...
          Column(children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                'Your subscription is ended ,please reactive subscription',
...
//        fit: StackFit.expand,
          ...
          Column(children: <Widget>[
            ...
            StickyHeader(header:  Container(
              ...
              padding: EdgeInsets.all(5),
              child: Text(
                'Your acount is not active ,please review application company ',
                style: const TextStyle(color: Colors.white,fontWeight: FontWeight.bold),
              ),
            ),content:  Column(
              crossAxisAlignment: CrossAxisAlignment.start,
