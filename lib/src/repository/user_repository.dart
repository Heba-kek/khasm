...
Future<User> login(String phone,String token,String codeC,String islog) async {
   String url;
  if(islog=='1'){
      url = 'http://142.93.224.195/api/signin?mobile_no='+phone+'&country_code='+codeC+'&otp='+'1'+'&device_token='+token;

  }else{
    url = 'http://142.93.224.195/api/signin?mobile_no='+phone+'&country_code='+codeC+'&device_token='+token;
