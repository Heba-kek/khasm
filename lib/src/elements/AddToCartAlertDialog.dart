      ...
      content: Column(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Text(
              S.of(context).you_must_add_Vawchars_of_the_same_Servicess_choose_one,
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 8),
                              Text(
                                S.of(context).reset_your_cart_and_order_meals_form_this_Services,
                                style: Theme.of(context).textTheme.caption,
                              ),
                            ],
                          ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 8),
                              Text(
                                S.of(context).keep_your_old_meals_of_this_Services,
                                style: Theme.of(context).textTheme.caption,
                              ),
                            ],
                          ),
