...
class S {
  ...
  String get search_for_Servicess_or_Vawchars {
    return Intl.message(
      'Search for Service provider or voucher',
      name: 'search_for_Servicess_or_Vawchars',
      desc: '',
      args: [],
    );
  }

  String get top_Servicess {
    return Intl.message(
  ...
  String get double_click_on_the_Vawchar_to_add_it_to_the {
    return Intl.message(
      'Double click on the voucher to add it to the cart',
      name: 'double_click_on_the_Vawchar_to_add_it_to_the',
      desc: '',
      args: [],
    );
  }

  String get Vawchar_categories {
    return Intl.message(
      'voucher Categories',
      name: 'Vawchar_categories',
      desc: '',
      args: [],
    );
  }
  ...
  String get featured_Vawchars {
    return Intl.message(
      'Featured voucher',
      name: 'featured_Vawchars',
      desc: '',
      args: [],
    );
  }
  ...
  String get favorite_Vawchars {
    return Intl.message(
      'Favorite voucher',
      name: 'favorite_Vawchars',
      desc: '',
      args: [],
    );
  }
  ...
  String get select_extras_to_add_them_on_the_Vawchar {
    return Intl.message(
      'Select extras to add them on the voucher',
      name: 'select_extras_to_add_them_on_the_Vawchar',
      desc: '',
      args: [],
    );
  }
  ...
  String get longpress_on_the_Vawchar_to_add_suplements {
    return Intl.message(
      'Longpress on the voucher to add suplements',
      name: 'longpress_on_the_Vawchar_to_add_suplements',
      desc: '',
      args: [],
    );
  }
  ...
  String get you_can_discover_Servicess {
    return Intl.message(
      'You can discover Service provider & fastvoucher arround you and choose you best meal after few minutes we prepare and delivere it for you',
      name: 'you_can_discover_Servicess',
      desc: '',
      args: [],
    );
  }
  ...
  String get you_must_add_Vawchars_of_the_same_Servicess_choose_one {
    return Intl.message(
      'You must add voucher of the same Service provider choose one Service provider only!',
      name: 'you_must_add_Vawchars_of_the_same_Servicess_choose_one',
      desc: '',
      args: [],
    );
  }

  String get reset_your_cart_and_order_meals_form_this_Services {
    return Intl.message(
      'Reset your cart and order meals form this Service provider',
      name: 'reset_your_cart_and_order_meals_form_this_Services',
      desc: '',
      args: [],
    );
  }

  String get keep_your_old_meals_of_this_Services {
    return Intl.message(
      'Keep your old meals of this Service provider',
      name: 'keep_your_old_meals_of_this_Services',
      desc: '',
      args: [],
    );
  }
  ...
  String the_Vawchar_was_removed_from_your_cart(Object Vawcharname) {
    return Intl.message(
      'The $Vawcharname was removed from your cart',
      name: 'the_Vawchar_was_removed_from_your_cart',
      desc: '',
      args: [Vawcharname],
    );
  }
  ...
  String get Services_refreshed_successfuly {
    return Intl.message(
      'Service provider refreshed successfully',
      name: 'Services_refreshed_successfuly',
      desc: '',
      args: [],
    );
  }
  ...
  String get tell_us_about_this_Services {
    return Intl.message(
      'Tell us about this Service provider',
      name: 'tell_us_about_this_Services',
      desc: '',
      args: [],
    );
  }

  String get how_would_you_rate_this_Services_ {
    return Intl.message(
      'How would you rate this Service provider ?',
      name: 'how_would_you_rate_this_Services_',
      desc: '',
      args: [],
    );
  }

  String get tell_us_about_this_Vawchar {
    return Intl.message(
      'Tell us about this voucher',
      name: 'tell_us_about_this_Vawchar',
      desc: '',
      args: [],
    );
  }

  String get the_Services_has_been_rated_successfully {
    return Intl.message(
      'The Service provider has been rated successfully',
      name: 'the_Services_has_been_rated_successfully',
      desc: '',
      args: [],
    );
  }

  String get the_Vawchar_has_been_rated_successfully {
    return Intl.message(
      'The voucher has been rated successfully',
      name: 'the_Vawchar_has_been_rated_successfully',
      desc: '',
      args: [],
    );
  }
  ...
  String get Servicess_near_to_your_current_location {
    return Intl.message(
      'Service provider near to your current location',
      name: 'Servicess_near_to_your_current_location',
      desc: '',
      args: [],
    );
  }

  String get Servicess_near_to {
    return Intl.message(
      'Service provider near to',
      name: 'Servicess_near_to',
      desc: '',
      args: [],
    );
  }
  ...
  String get pickup_your_Vawchar_from_the_Services {
    return Intl.message(
      'Pickup your voucher from the Service provider',
      name: 'pickup_your_Vawchar_from_the_Services',
      desc: '',
      args: [],
    );
  }
  ...
  String get opened_Servicess {
    return Intl.message(
      'Opened Service provider',
      name: 'opened_Servicess',
      desc: '',
      args: [],
    );
  }
  ...
  String get this_Vawchar_was_added_to_cart {
    return Intl.message(
      'This voucher was added to cart',
      name: 'this_Vawchar_was_added_to_cart',
      desc: '',
      args: [],
    );
  }

  String get Vawchars_result {
    return Intl.message(
      'voucher result',
      name: 'Vawchars_result',
      desc: '',
      args: [],
    );
  }

  String get Vawchars_results {
    return Intl.message(
      'voucher Results',
      name: 'Vawchars_results',
      desc: '',
      args: [],
    );
  }

  String get Servicess_results {
    return Intl.message(
      'Service provider Results',
      name: 'Servicess_results',
      desc: '',
      args: [],
    );
  }
  ...
  String get this_Services_is_closed_ {
    return Intl.message(
      'This Service provider is closed !',
      name: 'this_Services_is_closed_',
      desc: '',
      args: [],
    );
  }
  ...
  String get how_would_you_rate_this_Services {
    return Intl.message(
      'How would you rate this Service provider ?',
      name: 'how_would_you_rate_this_Services',
      desc: '',
      args: [],
    );
  }
  ...
  String get thisVawcharWasAddedToFavorite {
    return Intl.message(
      'This voucher was added to favorite',
      name: 'thisVawcharWasAddedToFavorite',
      desc: '',
      args: [],
    );
  }

  String get thisVawcharWasRemovedFromFavorites {
    return Intl.message(
      'This voucher was removed from favorites',
      name: 'thisVawcharWasRemovedFromFavorites',
      desc: '',
      args: [],
    );
  }

  String get VawcharRefreshedSuccessfuly {
    return Intl.message(
      'voucher refreshed successfully',
      name: 'VawcharRefreshedSuccessfuly',
      desc: '',
      args: [],
    );
  }

  String get deliveryAddressOutsideTheDeliveryRangeOfThisServicess {
    return Intl.message(
      'Delivery address outside the delivery range of this Service provider.',
      name: 'deliveryAddressOutsideTheDeliveryRangeOfThisServicess',
      desc: '',
      args: [],
    );
  }

  String get thisServicesNotSupportDeliveryMethod {
    return Intl.message(
      'This Service provider not support delivery method.',
      name: 'thisServicesNotSupportDeliveryMethod',
      desc: '',
      args: [],
    );
  }

  String get oneOrMoreVawcharsInYourCartNotDeliverable {
    return Intl.message(
      'One or more voucher in your cart not deliverable.',
      name: 'oneOrMoreVawcharsInYourCartNotDeliverable',
      desc: '',
      args: [],
    );
  }
  ...
  String get clickOnTheVawcharToGetMoreDetailsAboutIt {
    return Intl.message(
      'Click on the voucher to get more details about it',
      name: 'clickOnTheVawcharToGetMoreDetailsAboutIt',
      desc: '',
      args: [],
    );
  }
